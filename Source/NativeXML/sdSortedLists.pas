...
function CompareSingle(const Single1, Single2: double): integer;
...
function CompareBool(Bool1, Bool2: boolean): integer;
begin
  if Bool1 < Bool2 then Result := -1 else
    if Bool1 > Bool2 then Result := 1 else
      Result := 0;
end;
...
function CompareSingle(const Single1, Single2: double): integer;
begin
  if Single1 < Single2 then Result := -1 else
    if Single1 > Single2 then Result := 1 else
      Result := 0;
end;
...
function CompareDouble(const Double1, Double2: double): integer;
begin
  if Double1 < Double2 then Result := -1 else
    if Double1 > Double2 then Result := 1 else
      Result := 0;
end;
